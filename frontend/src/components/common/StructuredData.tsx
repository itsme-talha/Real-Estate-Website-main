...
const StructuredData: React.FC<StructuredDataProps> = ({ type, data }) => {
  ...
  const schemas: Record<string, object> = {
    website: {
      ...
      name: 'BuildEstate',
      url: SITE_URL,
      description: 'AI-powered luxury real estate platform for finding your perfect property in Pakistan.',
      potentialAction: {
        '@type': 'SearchAction',
    ...
    property: {
      ...
      ...(data?.price && { price: `PKR ${data.price}`, priceCurrency: 'PKR' }),
      ...(data?.sqft && {
        floorSize: {
    ...
    aiHub: {
      ...
      description: 'AI-powered real estate analytics, property search, and investment insights for Pakistan.',
      url: `${SITE_URL}/ai-hub`,
      offers: {
        '@type': 'Offer',
        price: '0',
