      ...
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {methods.map((method, index) => (
            <div 
              key={index}
              className="bg-[#0F3B43] border border-[#B7A08B]/20 rounded-2xl p-8 hover:shadow-xl hover:border-[#B7A08B]/50 transition-all group"
            >
              {/* Icon */}
              <div className={`w-16 h-16 ${method.bgColor} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
                <span className="material-icons text-3xl text-[#B7A08B]">
                  {method.icon}
                </span>
              </div>
              ...
              {/* Description */}
              <p className="font-manrope font-extralight text-sm text-white/70 leading-relaxed mb-6">
                {method.description}
              </p>
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 font-manrope font-bold text-sm text-[#B7A08B] hover:text-white transition-colors group"
              >
