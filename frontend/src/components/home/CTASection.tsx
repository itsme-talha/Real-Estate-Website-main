    ...
    <section className="bg-[#B7A08B] py-24 relative overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-8 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link to="/signup" className="bg-[#154D57] text-white font-manrope font-bold text-lg px-10 py-4 rounded-xl shadow-lg hover:shadow-2xl hover:bg-white hover:text-[#154D57] transition-all inline-block">
            Get Started
          </Link>
          <Link to="/contact" className="border-2 border-[#154D57] text-[#154D57] font-manrope font-bold text-lg px-10 py-4 rounded-xl hover:bg-[#154D57] hover:text-white transition-all inline-block">
            Schedule a Demo
          </Link>
        </div>
      </div>
