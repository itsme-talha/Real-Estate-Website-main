...
const PropertyAbout: React.FC<PropertyAboutProps> = ({ 
  description = `Discover the epitome of urban luxury at Skyline Towers. This meticulously designed 4-bed residence offers a seamless blend of contemporary architecture and premium living. The property features an expansive living area with floor-to-ceiling windows, premium oak flooring, and state-of-the-art smart home integration.
    ...
    <div className="mb-12">
      ...
      <div className="space-y-4">
        {description.split('\n\n').map((paragraph, index) => (
          <p 
            key={index}
            className="font-manrope font-extralight text-base text-white/70 leading-relaxed"
          >
            {paragraph}
          </p>
        ))}
