    ...
    <div className="min-h-screen pt-8 pb-12 px-4 bg-[#154D57]">
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-3xl font-bold text-white mb-1 drop-shadow-sm">Add New Property</h1>
          <p className="text-[#B7A08B]">Fill in the details to list a new property on BuildEstate</p>
        </motion.div>
        ...
        >
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="text" id="title" name="title" required value={formData.title}
                  onChange={handleInputChange} placeholder="e.g. Modern 3BHK Apartment in Gulberg"
                ...
                <div>
                  ...
                  <select id="type" name="type" required value={formData.type}
                    ...
                    {PROPERTY_TYPES.map((type) => (
                      <option key={type} value={type} className="bg-[#12434D] text-white">{type}</option>
                    ))}
                  </select>
                </div>
                <div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="number" id="price" name="price" required min="0"
                    ...
                    placeholder="e.g. 50000000" className={cn(inputClass, 'pl-10')} />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" id="location" name="location" required
                    ...
                    placeholder="e.g. DHA Phase 6, Lahore" className={cn(inputClass, 'pl-10')} />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="tel" id="phone" name="phone" required
                    ...
                    placeholder="+92 300 1234567" className={cn(inputClass, 'pl-10')} />
                </div>
              </div>
              <div>
          ...
          <div className="bg-[#12434D] rounded-2xl p-6 border border-[#B7A08B]/20 shadow-xl">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <div className="relative">
                  <BedDouble className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#B7A08B]/60" />
              ...
              <div>
                ...
                <div className="relative">
                  <Bath className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#B7A08B]/60" />
              ...
              <div>
                ...
                <div className="relative">
                  <Maximize className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#B7A08B]/60" />
          ...
          <div className="bg-[#12434D] rounded-2xl p-6 border border-[#B7A08B]/20 shadow-xl">
            ...
            {previewUrls.length < 4 && (
              <label htmlFor="images"
                className="flex flex-col items-center justify-center w-full h-36 border-2 border-dashed border-[#B7A08B]/30 rounded-xl cursor-pointer bg-[#0F3B43] hover:border-[#B7A08B] hover:bg-[#B7A08B]/5 transition-all duration-200 group">
                <Upload className="w-8 h-8 text-[#B7A08B]/50 group-hover:text-[#B7A08B] mb-2 transition-colors" />
          ...
          <motion.button
            ...
            className="w-full py-4 bg-[#B7A08B] hover:bg-white text-[#154D57] rounded-xl font-bold text-lg transition-all duration-300 shadow-lg disabled:opacity-60 disabled:cursor-not-allowed"
          >
